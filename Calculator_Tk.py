...
class Window(Frame):
    ...
    def initWindow(self):
        ...
        oneButton = Button(self, text="1", command=lambda: self.displayNumber("1"))
        oneButton.grid(row=1, column=0)

        twoButton = Button(self, text="2", command=lambda: self.displayNumber("2"))
        twoButton.grid(row=1, column=1)

        threeButton = Button(self, text="3", command=lambda: self.displayNumber("3"))
        threeButton.grid(row=1, column=2)

        fourButton = Button(self, text="4", command=lambda: self.displayNumber("4"))
        fourButton.grid(row=2, column=0)

        fiveButton = Button(self, text="5", command=lambda: self.displayNumber("5"))
        fiveButton.grid(row=2, column=1)

        sixButton = Button(self, text="6", command=lambda: self.displayNumber("6"))
        sixButton.grid(row=2, column=2)

        sevenButton = Button(self, text="7", command=lambda: self.displayNumber("7"))
        sevenButton.grid(row=3, column=0)

        eightButton = Button(self, text="8", command=lambda: self.displayNumber("8"))
        eightButton.grid(row=3, column=1)

        nineButton = Button(self, text="9", command=lambda: self.displayNumber("9"))
        nineButton.grid(row=3, column=2)

        zeroButton = Button(self, text="0", command=lambda: self.displayNumber("0"))
        zeroButton.grid(row=4, column=0)

        # Mathematical operates buttons:

        addButton = Button(self, text="+", command=lambda: self.displayNumber(" + "))
        addButton.grid(row=1, column=3)

        subButton = Button(self, text=" -", command=lambda: self.displayNumber(" - "))
        subButton.grid(row=2, column=3)

        exprButton = Button(self, text="=", command=lambda: self.calcExpr())
        exprButton.grid(row=3, column=3)

        clearButton = Button(self, text="/", command=lambda: self.displayNumber("/"))
        clearButton.grid(row=4, column=1)

        clearButton = Button(self, text="*", command=lambda: self.displayNumber("*"))
        clearButton.grid(row=4, column=2)

        clearButton = Button(self, text="C", command=lambda: self.clearText())
